...
runtime-bound validation audit, recovery next ensures the marker-keyed ordinary
comment with every final child reference. The final source update atomically
