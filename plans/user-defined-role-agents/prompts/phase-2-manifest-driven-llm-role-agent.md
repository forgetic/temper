...
3. Read:
   ...
   - `crates/harness-agents/src/common.rs`
...
Introduce a generic, manifest-driven LLM role agent in `harness-agents`.
...
- `harness-forge`, `harness-runner`, and `harness-workflow` remain LLM-agnostic.
