Repair the selected retry behavior with the smallest semantic change.

Use each successful targeted provider result with this work item before choosing
the dependent refinement, trace, current-root implementation source, or focused
behavioral-test source in a later model turn. Consume the approved multi-part
lineage completely before mutation. Do not use broad architecture or inventory
