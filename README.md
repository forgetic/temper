...
- The next likely implementation task is idempotent PR create (Phase 10, mirroring `Executor::ensure_issue`), addressing the limitations the robustness tests surfaced (compare-and-swap lease acquisition, applying reconciler actions automatically), or adding another concrete Forge backend. See `docs/reference/robustness-guarantees.md`.
