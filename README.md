...
- The next likely implementation task is addressing the limitations the robustness tests surfaced (compare-and-swap lease acquisition, applying reconciler actions automatically), continuing the reference-workflow backlog (`dependency_gate`), or adding another concrete Forge backend. See `docs/reference/robustness-guarantees.md` and `docs/explanation/reference-workflow-roadmap.md`.
