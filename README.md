...
- The next likely implementation task is to address the limitations the robustness tests surfaced (compare-and-swap lease acquisition, pull-request idempotent create, applying reconciler actions automatically, executing non-label transition effects), or to add another concrete Forge backend. See `docs/reference/robustness-guarantees.md`.
