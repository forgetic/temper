...
- The reference-workflow backlog (Phases 9a–14) is complete. The next likely implementation task is addressing the limitations the robustness tests surfaced (compare-and-swap lease acquisition, automatically applying reconciler actions — including the dependency `Unblock`), or adding another concrete Forge backend. See `docs/reference/robustness-guarantees.md` and `docs/explanation/reference-workflow-roadmap.md`.
