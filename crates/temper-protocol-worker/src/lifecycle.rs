...
/// durable human-facing progress only (step label, lifecycle phase, pushed
/// sha, optional note) -- high-frequency observability belongs to the
/// out-of-band control plane and must not grow fields here.
///
...
/// the daemon resolves it to its in-flight job. Delivery is fire-and-forget;
