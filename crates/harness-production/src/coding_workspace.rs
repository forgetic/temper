...
//! commits the resulting branch, checks that the diff is not Harness
...
pub const WORKSPACE_ROOT_ENV: &str = "HARNESS_CODING_WORKSPACE_ROOT";
pub const WORKSPACE_COMMAND_ENV: &str = "HARNESS_CODING_WORKSPACE_COMMAND";
pub const WORKSPACE_REMOTE_ENV: &str = "HARNESS_CODING_WORKSPACE_REMOTE";
pub const WORKSPACE_PUSH_ENV: &str = "HARNESS_CODING_WORKSPACE_PUSH";
pub const WORKSPACE_PR_LABELS_ENV: &str = "HARNESS_CODING_WORKSPACE_PR_LABELS";
...
fn run_edit_command(
    ...
    cmd.args(&command[1..])
        .current_dir(root)
        .env("HARNESS_CODING_WORKSPACE_CONTEXT", context_file)
        .env("HARNESS_CODING_WORKSPACE_BRANCH", &request.branch_hint)
        .env("HARNESS_CODING_WORKSPACE_BASE", &request.base_branch)
        .env(
            "HARNESS_CODING_WORKSPACE_REPOSITORY",
            format!("{}/{}", request.repository.owner, request.repository.name),
        )
        .env(
            "HARNESS_CODING_WORKSPACE_CORRELATION_KEY",
