...
//!   cargo test -p harness-testing --test forgejo_ci_web_ui -- --ignored
//! ```
//!
...
use harness_forge::{CiJobConclusion, CiJobQuery, CiJobStatus};
use harness_forge_forgejo::{ForgejoConfig, ForgejoForge};
use harness_testing::forgejo_server::{provision, ForgejoRunner, ForgejoServer};
...
fn enabled() -> bool {
    ...
    eprintln!(
        "skipping Forgejo CI web-UI e2e test: set HARNESS_FORGEJO_E2E=1 to enable \
