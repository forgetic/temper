//! Online request-body oracle for anvil's real outbound provider requests.
//!
...
//! actual request emitted by `temper_agent::run_decision` through
...
fn anvil_requests_match_jig_authoritative_templates() {
