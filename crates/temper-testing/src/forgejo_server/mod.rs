//! A throwaway, locally-run Forgejo server for the env-gated end-to-end fixture.
//!
...
//! `#[ignore]`d, `TEMPER_FORGEJO_E2E=1`-gated test constructs one, matching the
//! `temper-forge-forgejo` live-test precedent.
//!
