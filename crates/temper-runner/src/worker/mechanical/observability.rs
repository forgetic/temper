...
pub(super) fn log_mechanical_reconciliation_summary(
    ...
    tracing::debug!(
        target: "temper::worker",
        measurement = "mechanical.reconciliation",
        worker_kind = "mechanical",
        worker,
        ...
        detail_cache.invalidation_count = report.cache_stats.invalidations,
        detail_cache.eviction_count = report.cache_stats.evictions,
