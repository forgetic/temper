...
use harness_forge::{CreateIssue, CreateRepository, Forge, ItemNumber, RepositoryId, UserId};
use harness_forge_memory::MemoryForge;
use harness_runner::{Agent, AgentError, Progress, RoleTools, RoleWorker, WorkItem, Worker};
...
fn engineer_worker<'a>(
    ...
    compiled: &'a harness_workflow::CompiledWorkflow,
