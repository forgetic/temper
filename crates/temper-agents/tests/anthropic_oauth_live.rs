...
//!   cargo test -p temper-agents --test anthropic_oauth_live -- --ignored --nocapture
//! ```

use std::time::Instant;
use temper_agents::{AuthChoice, ProviderConfig, ProviderRoleDecisionEngine, RoleDecisionEngine};
