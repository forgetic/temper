...
pub(super) fn field_alias(key: &str) -> Option<&'static str> {
    match key {
        ...
        "session_failure_count" => Some("session_failure_count"),
        "failure_count" | "cumulative_failure_count" => Some("cumulative_failure_count"),
        "elapsed_ms" => Some("elapsed_ms"),
        "disposition" | "final_disposition" => Some("final_disposition"),
        "boundary" => Some("boundary"),
        "event_kind" => Some("event_kind"),
        "provider_request_id" => Some("provider_request_id"),
        "status_present" => Some("status_present"),
        "code_present" => Some("code_present"),
        "generation" | "deferral_generation" => Some("generation"),
        "deferral_count" => Some("deferral_count"),
        "workstream_id" => Some("workstream_id"),
        "health_event_id" => Some("health_event_id"),
