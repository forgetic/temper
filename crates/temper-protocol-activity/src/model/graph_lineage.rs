...
/// Closed semantic purposes which a trusted source wrapper may declare.
///
/// These values are supplied explicitly to the wrapper. They are never
/// inferred from provider output, source text, paths, selectors, or prose.
#[derive(Clone, Copy, Debug, Eq, Ord, PartialEq, PartialOrd, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum DecisionEvidenceKindV1 {
    Implementation,
    Caller,
    FocusedTest,
}
...
impl DecisionAnchorLineageV1 {
    ...
    /// Builds source lineage carrying one explicit, closed decision purpose.
    pub fn new_with_decision_evidence_kind(
        root_binding: String,
        stage: DecisionAnchorLineageStageV1,
        target_kind: DecisionAnchorTargetKindV1,
        result_target_kinds: impl IntoIterator<Item = DecisionAnchorTargetKindV1>,
        decision_evidence_kind: DecisionEvidenceKindV1,
    ) -> Option<Self> {
        Self::new_with_canonical_target_digests_and_evidence_kind(
            root_binding,
            stage,
            target_kind,
            result_target_kinds,
            [],
            Some(decision_evidence_kind),
        )
    }
    ...
    /// Builds canonical lineage with optional wrapper-declared source purpose.
    pub fn new_with_canonical_target_digests_and_evidence_kind(
        root_binding: String,
        stage: DecisionAnchorLineageStageV1,
        target_kind: DecisionAnchorTargetKindV1,
        result_target_kinds: impl IntoIterator<Item = DecisionAnchorTargetKindV1>,
