...
//! [`ForgeAdmin`](temper_forge::ForgeAdmin) trait impls, not part of any Forge
...
use temper_forge::{ForgeResult, RepoPermission, RepositoryId, WebhookSpec};
...
impl FilesystemForge {
    ...
    /// [`commit_file`](temper_forge::ForgeContent::commit_file).
    ///
    /// Test-only read-back companion surface, not part of any Forge trait.
