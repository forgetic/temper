...
pub use trace::{
    ...
    TraceError, TraceManifestV1, TraceReclamationReport, TraceRun, TraceSpoolEntry,
    TraceSpoolInventory, TraceSpoolOutcome, TraceSpoolOutcomeCounts, WORKER_SPOOL_RUN_CAPACITY,
};
